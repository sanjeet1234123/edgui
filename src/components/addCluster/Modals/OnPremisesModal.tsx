...
type OnPremisesModalProps = {
  opened: boolean
  close: () => void
}

const onPremClusterConfigurationSchema = z.object({
...
function OnPremisesModal({ opened, close }: OnPremisesModalProps) {
  ...
  const form = useForm<OnPremClusterConfiguration>({
    ...
    validate: zodResolver(onPremClusterConfigurationSchema),
  })
        ...
        title={
          <Group>
            ...
            <Stack gap={0}>
              ...
              <Text fz="var(--size-sm)" fw={400} c="dimmed">
                Your cluster has been added successfully
              </Text>
            </Stack>
          </Group>
        }
      >
        <Stack gap="xl" align="center">
          ...
          <Text ta="center" fz="var(--size-lg)" fw={500}>
            Your OnPrem Cluster has been successfully onboarded. You're all set
...
export default OnPremisesModal
